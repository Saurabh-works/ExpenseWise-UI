  ...
  return (
    <Box sx={{ padding: 4, color: "white" }}>
      <Typography variant="h5" sx={{ mb: 3, color: "white" }}>
        <span style={{borderBottom:"1px solid #F78D6A", paddingBottom:"2px"}} >Schedule Alerts</span>
      </Typography>
      ...
      <span style={{borderBottom:"1px solid #F78D6A", paddingBottom:"2px"}} >Alerts History:</span>
      </Typography>
